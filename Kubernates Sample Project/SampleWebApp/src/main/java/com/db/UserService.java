...
import main.java.com.bean.jpa.UserJPA;
...
public class UserService {
	...
	public void persistTestFor3Tier(String name, String age) throws Exception{
		UserJPA jpaBean = new UserJPA();
		jpaBean.setFullName(name);
		jpaBean.setAge(age);
		EntityManagerFactory emf = createEntityManageFactory();
		EntityManager em = emf.createEntityManager();
	...
	public void createUserTable() throws Exception{
		...
		String query="CREATE TABLE USERS_DETAILS(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, FULL_NAME VARCHAR(20), AGE int)";
